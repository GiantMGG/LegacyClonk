...
C4AbortGameDialog::C4AbortGameDialog()
	: C4GUI::Dialog((Game.Control.isCtrlHost() || (Game.GameC4S.Head.Film == 2)) ? 400 : C4GUI::MessageDialog::dsSmall, 100, LoadResStr(C4ResStrTableKey::IDS_DLG_ABORT), false), fGameHalted(false)
{
	const auto showRestart = (Game.Control.isCtrlHost() || (Game.GameC4S.Head.Film == 2));
