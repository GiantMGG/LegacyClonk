...
{
public:
	constexpr C4Value() noexcept : NextRef(nullptr), FirstRef(nullptr), Type(C4V_Any) { Data.Raw = 0; }
	...
	explicit constexpr C4Value(C4ID id) noexcept : NextRef(nullptr), FirstRef(nullptr), Type(id ? C4V_C4ID : C4V_Any)
	{
		Data.Raw = id;
	}

	explicit constexpr C4Value(C4ValueInt value) noexcept : NextRef(nullptr), FirstRef(nullptr), Type(C4V_Int)
	{
		Data.Raw = value;
	}

	explicit constexpr C4Value(bool value) noexcept : NextRef(nullptr), FirstRef(nullptr), Type(C4V_Bool)
	{
		Data.Raw = value;
	}
...
{
	constexpr static C4V_Type Type() { return C4V_Bool; }
...
{
	constexpr static C4V_Type Type() { return C4V_String; }
...
{
	constexpr static C4V_Type Type() { return C4V_Array; }
...
{
	constexpr static C4V_Type Type() { return C4V_Map; }
...
{
	constexpr static C4V_Type Type() { return C4V_pC4Value; }
	static C4Value *FromC4V(C4Value &v) { return v.getRef(); }
